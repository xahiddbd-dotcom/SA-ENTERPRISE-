...
export const initialStaff: User[] = [
  {
    id: "usr_admin",
    name: "Saiful Islam",
    nameBn: "সাইফুল ইসলাম (স্বত্বাধিকারী ও প্রধান অ্যাডমিন)",
  ...
  },
  {
    id: "usr_op_tanvir",
    name: "Tanvir Ahmed",
    nameBn: "তানভীর আহমেদ (সিনিয়র কম্পিউটার অপারেটর)",
    email: "tanvir.se@gmail.com",
    phone: "01712-345678",
    role: "service_operator",
    employeeId: "SE-OP-01",
    designation: "Senior Computer & Fast Typing Specialist",
    designationBn: "সিনিয়র কম্পিউটার ও দ্রুত টাইপিং অপারেটর",
    bio: "Specialist in Bengali/English official typing, legal deeds draft, and urgent online forms.",
    bioBn: "বাংলা ও ইংরেজি দ্রুত টাইপিং, কোর্টের হলফনামা ও দলিল কম্পোজে বিশেষ পারদর্শী।",
    skills: ["Bijoy & Avro Typing", "MS Word", "Photoshop", "Govt Job Forms"],
    skillsBn: ["বিজয় ও অভ্র টাইপিং", "এমএস ওয়ার্ড", "ফটوشপ", "চাকরির আবেদন"],
    socialLinks: { phone: "01712345678", whatsapp: "01712345678" },
    ...
    isBlocked: false,
    salary: 22000,
    shift: "সকাল শিফট (Morning: 8:00 AM - 4:00 PM)",
    performanceScore: 96,
  ...
  },
  {
    id: "usr_op_sakib",
    name: "Sakib Hasan",
    nameBn: "সাকিব হাসান (ফটোকপি ও ডিজিটাল প্রিন্ট)",
    email: "sakib.se@gmail.com",
    phone: "01823-456789",
    role: "service_operator",
    employeeId: "SE-OP-02",
    designation: "Photocopy & High-Speed Laser Copier Operator",
    designationBn: "ফটোকপি ও হাই-স্পিড লেজার প্রিন্টার অপারেটর",
    bio: "Expert in Canon/Toshiba digital photocopiers, book binding, and paper maintenance.",
    bioBn: "তোশিবা ও ক্যানন হেভি ফটোকপিয়ার পরিচালনা, কালার প্রিন্ট ও বুক বাইন্ডিং বিশেষজ্ঞ।",
    skills: ["Heavy Copier", "Paper GSM", "Spiral Binding", "Lamination"],
    skillsBn: ["হেভি ফটোকপিয়ার", "পেপার জিএসএম", "স্পাইরাল বাইন্ডিং", "ল্যামিনেশন"],
    socialLinks: { phone: "01823456789", whatsapp: "01823456789" },
    ...
    isBlocked: false,
    salary: 20000,
    shift: "বিকাল শিফট (Evening: 3:00 PM - 11:00 PM)",
    performanceScore: 94,
  ...
  },
  {
    id: "usr_op_rahim",
    name: "Abdur Rahim",
    nameBn: "আব্দুর রহিম (অনলাইন আবেদন ও কলেজ ভর্তি)",
    email: "rahim.se@gmail.com",
    phone: "01934-567890",
    role: "service_operator",
    employeeId: "SE-OP-03",
    designation: "Online Admission & Govt Services Specialist",
    designationBn: "অনলাইন আবেদন ও তেজগাঁও কলেজ ভর্তি বিশেষজ্ঞ",
    bio: "Tejgaon College honors/masters admission forms, army/navy recruitment, and BMET card applications.",
    bioBn: "তেজগাঁও কলেজ ভর্তি ফরম, জাতীয় বিশ্ববিদ্যালয় সনদ ও সরকারি চাকরির আবেদনে দক্ষ।",
    skills: ["College Admission", "Police Clearance", "BMET Registration", "NU Forms"],
    skillsBn: ["কলেজ ভর্তি", "পুলিশ ক্লিয়ারেন্স", "বিএমইটি বায়োমেট্রিক", "জাতীয় বিশ্ববিদ্যালয়"],
    socialLinks: { phone: "01934567890", whatsapp: "01934567890" },
    ...
    isBlocked: false,
    salary: 19500,
    shift: "সকাল শিফট (Morning: 9:00 AM - 5:00 PM)",
    performanceScore: 95,
  ...
  },
  {
    id: "usr_op_mehedi",
    name: "Mehedi Hasan",
    nameBn: "মেহেদী হাসান (গ্রাফিক্স ডিজাইন ও ল্যাব ফটো)",
    email: "mehedi.se@gmail.com",
    phone: "01645-678901",
    role: "service_operator",
    employeeId: "SE-OP-04",
    designation: "Studio Photo Lab & Graphics Designer",
    designationBn: "স্টুডিও ফটো ল্যাব ও গ্রাফিক্স ডিজাইনার",
    bio: "Passport & visa photo lab printing, retouching, certificate editing, and banner design.",
    bioBn: "পাসপোর্ট ও ভিসা ছবি প্রিন্ট, ব্যাকগ্রাউন্ড পরিবর্তন ও জরুরি আইডি কার্ড ল্যামিনেশন।",
    skills: ["Adobe Photoshop", "Illustrator", "Photo Color Correction", "ID Card"],
    skillsBn: ["অ্যাডোবি ফটশপ", "ইলাস্ট্রেটর", "ছবি কালার কারেকশন", "আইডি কার্ড"],
    socialLinks: { phone: "01645678901", whatsapp: "01645678901" },
    ...
    isBlocked: false,
    salary: 21000,
    shift: "পূর্ণ দিবস (Full Day: 10:00 AM - 8:00 PM)",
    performanceScore: 93,
  ...
  },
  {
    id: "usr_op_tariqul",
    name: "Tariqul Islam",
    nameBn: "তারিকুল ইসলাম (স্ট্যাম্প ও আইনি দলিল লেখক)",
    email: "tariqul.se@gmail.com",
    phone: "01734-889900",
    role: "service_operator",
    employeeId: "SE-OP-05",
    designation: "Judicial Stamp & Legal Deed Typing Specialist",
    designationBn: "জুডিশিয়াল স্ট্যাম্প ও আইনি দলিল লেখক",
    bio: "Judicial non-judicial stamp paper typing, lease agreements, affidavits, and notary drafting.",
    bioBn: "জুডিশিয়াল ও নন-জুডিশিয়াল স্ট্যাম্প টাইপিং, নোটারি পাবলিক এফিডেভিট ও ভাড়ানামা প্রস্তুতকারক।",
    skills: ["Legal Drafting", "Stamp Paper", "Affidavits", "Power of Attorney"],
    skillsBn: ["আইনি খসড়া", "স্ট্যাম্প পেপার", "হলফনামা", "চুক্তিপত্র"],
    socialLinks: { phone: "01734889900", whatsapp: "01734889900" },
    joiningDate: "2023-09-01",
    bloodGroup: "O+",
    emergencyContact: "01734889900",
    address: "Tejgaon, Dhaka",
    isActive: true,
    isBlocked: false,
    salary: 21500,
    shift: "সকাল শিフト (Morning: 8:30 AM - 4:30 PM)",
    performanceScore: 95,
  ...
  },
  {
    id: "usr_op_sohel",
    name: "Sohel Rana",
    nameBn: "সোহেল রানা (কমার্শিয়াল প্রিন্ট ও বাইন্ডিং)",
    email: "sohel.se@gmail.com",
    phone: "01856-112233",
    role: "service_operator",
    employeeId: "SE-OP-06",
    designation: "Heavy Printing, Lamination & Binding Specialist",
    designationBn: "কমার্শিয়াল প্রিন্টিং, লেমিনেশন ও স্পাইরাল বাইন্ডিং",
    bio: "High volume book printing, thesis hard binding, plastic comb spiral binding & PVC card lamination.",
    bioBn: "বই প্রিন্ট, থিসিস হার্ড বাইন্ডিং, স্পাইরাল বাইন্ডিং ও পিভিসি কার্ড লেমিনেশন বিশেষজ্ঞ।",
    skills: ["Color Press", "Hard Binding", "Lamination", "Spiral Comb"],
    skillsBn: ["কালার প্রেস", "হার্ড বাইন্ডিং", "লেমিনেশন", "স্পাইরাল"],
    socialLinks: { phone: "01856112233", whatsapp: "01856112233" },
    joiningDate: "2024-02-01",
    bloodGroup: "A+",
    emergencyContact: "01856112233",
    address: "Farmgate, Dhaka",
    isActive: true,
    isBlocked: false,
    salary: 20000,
    shift: "সন্ধ্যা শিフト (Evening: 3:00 PM - 10:30 PM)",
    performanceScore: 92,
...
export const initialDailyCounterSales: DailyCounterSale[] = [
  {
    ...
    date: todayStr,
    title: 'মালিকের ৬০% অংশ (তানভীর আহমেদ - সকাল শিফট)',
    category: 'cat_inc_operator_share',
    amount: 2100,
    paymentMethod: 'cash',
    operatorId: 'usr_op_tanvir',
    operatorName: 'Tanvir Ahmed',
    notes: 'মোট কাজ: ৳৩,৮০০, খরচ: ৳৩০০, নিট: ৳৩,৫০০ (মালিক ৬০%: ৳২,১০০, কর্মী ৪০%: ৳১,৪০০)',
  ...
  },
  {
    ...
    date: todayStr,
    title: 'মালিকের ৬০% অংশ (সাকিব হাসান - বিকাল শিফট)',
    category: 'cat_inc_operator_share',
    amount: 2400,
    paymentMethod: 'cash',
    operatorId: 'usr_op_sakib',
    operatorName: 'Sakib Hasan',
    notes: 'মোট কাজ: ৳৪,৫০০, খরচ: ৳৫০০, নিট: ৳৪,০০০ (মালিক ৬০%: ৳২,৪০০, কর্মী ৪০%: ৳১,৬০০)',
    createdAt: `${todayStr}T18:00:00Z`
  },
  {
    id: 'dcs_init_3',
    voucherNo: 'VCH-2026-0003',
    date: todayStr,
    title: 'মালিকের ৬০% অংশ (আব্দুর রহিম - সকাল শিফট)',
    category: 'cat_inc_operator_share',
    amount: 1500,
    paymentMethod: 'cash',
    operatorId: 'usr_op_rahim',
    operatorName: 'Abdur Rahim',
    notes: 'মোট কাজ: ৳২,৬০০, খরচ: ৳১০০, নিট: ৳২,৫০০ (মালিক ৬০%: ৳১,৫০০, কর্মী ৪০%: ৳১,০০০)',
    createdAt: `${todayStr}T16:15:00Z`
  }
];
...
export const initialStoreExpenses: StoreExpenseRecord[] = [
  {
    ...
    date: todayStr,
    title: 'কর্মীদের দুপুরের খাবার ও বিকালের চা-নাস্তা',
    category: 'cat_exp_tea',
    amount: 450,
    paymentMethod: 'cash',
    paidTo: 'নিউ ঢাকা হোটেল ও চা স্টল',
    notes: 'অপারেটরদের নিয়মিত আপ্যায়ন খরচ',
...
export const initialOperatorDailyLedgers: OperatorDailyLedger[] = [
  {
    ...
    operatorId: 'usr_op_tanvir',
    operatorName: 'Tanvir Ahmed',
    operatorAvatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&auto=format&fit=crop&q=80',
    operatorDesignation: 'সিনিয়র কম্পিউটার ও দ্রুত টাইপিং অপারেটর',
    operatorPhone: '01712-345678',
    counterNo: 'কাউন্টার-১ (কম্পিউটার ও টাইপিং)',
    shift: 'morning',
    grossServiceSales: 3800,
    operatorExpenses: 300,
    netServiceIncome: 3500,
    ownerSharePercentage: 60,
    ownerShareAmount: 2100,
    workerSharePercentage: 40,
    workerShareAmount: 1400,
    cashDepositedToOwner: 3500,
    counterCashInHand: 0,
    digitalCollection: 600,
    deductionPercentage: 60,
    deductionAmount: 2100,
    netAfterDeduction: 1400,
    pagesPrintedCount: 320,
    paperReamsUsed: 1,
    syncedToShopLedger: true,
    shopLedgerSaleId: 'dcs_init_1',
    status: 'settled',
    notes: 'কোর্টের ৩টি এফিডেভিট টাইপিং এবং ৩০টি অনলাইন চাকরির আবেদন।'
  },
  {
    id: 'odl_init_2',
    date: todayStr,
    operatorId: 'usr_op_sakib',
    operatorName: 'Sakib Hasan',
    operatorAvatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=400&auto=format&fit=crop&q=80',
    operatorDesignation: 'ফটোকপি ও হাই-স্পিড লেজার প্রিন্টার অপারেটর',
    operatorPhone: '01823-456789',
    counterNo: 'কাউন্টার-২ (ফটোকপি ও প্রিন্টিং)',
    shift: 'evening',
    grossServiceSales: 4500,
    operatorExpenses: 500,
    netServiceIncome: 4000,
    ownerSharePercentage: 60,
    ownerShareAmount: 2400,
    workerSharePercentage: 40,
    workerShareAmount: 1600,
    cashDepositedToOwner: 4000,
    counterCashInHand: 0,
    digitalCollection: 800,
    deductionPercentage: 60,
    deductionAmount: 2400,
    netAfterDeduction: 1600,
    pagesPrintedCount: 1250,
    paperReamsUsed: 3,
    syncedToShopLedger: true,
    shopLedgerSaleId: 'dcs_init_2',
    status: 'settled',
    notes: 'তেজগাঁও কলেজ ছাত্রদের লেকচার শিট প্রিন্ট ও কালার কভার ল্যামিনেশন।'
  },
  {
    id: 'odl_init_3',
    date: todayStr,
    operatorId: 'usr_op_rahim',
    operatorName: 'Abdur Rahim',
    operatorAvatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400&auto=format&fit=crop&q=80',
    operatorDesignation: 'অনলাইন আবেদন ও তেজগাঁও কলেজ ভর্তি বিশেষজ্ঞ',
    operatorPhone: '01934-567890',
    counterNo: 'কাউন্টার-৩ (অনলাইন ফর্ম ও আবেদন)',
    shift: 'morning',
    grossServiceSales: 2600,
    operatorExpenses: 100,
    netServiceIncome: 2500,
    ownerSharePercentage: 60,
    ownerShareAmount: 1500,
    workerSharePercentage: 40,
    workerShareAmount: 1000,
    cashDepositedToOwner: 2500,
    counterCashInHand: 0,
    digitalCollection: 1200,
    deductionPercentage: 60,
    deductionAmount: 1500,
    netAfterDeduction: 1000,
    pagesPrintedCount: 95,
    paperReamsUsed: 0.5,
    syncedToShopLedger: true,
    shopLedgerSaleId: 'dcs_init_3',
    status: 'settled',
    notes: 'তেজগাঁও কলেজ অনার্স প্রথম বর্ষ ভর্তি ফর্ম ও এনইউ রেজিস্ট্রেশন।'
  }
];
